    ...
    <div
        ...
        <div class="flex h-full items-center justify-center px-5 w-11/12 mx-auto gap-16">
            <div class="md:w-1/3 padding-inline-start mx-auto transform -translate-y-10">
              ...
              <div class="mt-5">
                <Button label="Learn More" class="bg-primary " />
              </div>
...
<div class="h-full w-full simple-linear">
  <div class="container pt-24 mx-auto md:px-6">
    <section class="mb-32 text-center">
      ...
      <div class="grid gap-x-6 md:grid-cols-2 lg:grid-cols-4 lg:gap-x-12">
        <div class="mb-12 lg:mb-0">
          <div class="mb-6 inline-block rounded-full bg-light-blue p-4 text-primary shadow">
