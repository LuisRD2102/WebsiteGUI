              ...
              <div
                ...
                <div class="px-8 py-12 md:py-16">
                  ...
                  <form class="mt-8">
                    ...
                    <div class="mt-4">
                      <div class="relative">
                        <input type="password" v-model="password" id="small_outlined2" class="block px-2.5 pb-1.5 pt-3 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        ...
                        <div class="mt-6">
                            <Button label="Sign in" class="w-full" @click="$router.push('/clients')"></Button>
                        </div>
                    </div>
                </form>
